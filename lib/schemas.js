...
const commonSlots = {
  comment: { type: "string" },
  creator_id: { type: "array", items: { $ref: "#/$defs/EntityReference" } },    // in SSSOM/TSV only
  creator_label: { type: "array", items: { type: "string" } },                  // in SSSOM/TSV only
...
export const mappingSchema = {
  ...
  properties: {
    ...
    author_id: { type: "array", items: { $ref: "#/$defs/EntityReference" } },   // in SSSOM/TSV only
    author_label: { type: "array", items: { type: "string" } },                 // in SSSOM/TSV only
    reviewer_id: { type: "array", items: { $ref: "#/$defs/EntityReference" } }, // in SSSOM/TSV only
    reviewer_label: { type: "array", items: { type: "string" } },               // in SSSOM/TSV only
