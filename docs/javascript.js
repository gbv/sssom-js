...
(function(mod) {
  ...
  CodeMirror.defineMode("javascript", function(config, parserConfig) {
    ...
    let keywords = function(){
      ...
      let A = kw("keyword a"), B = kw("keyword b"), C = kw("keyword c"), D = kw("keyword d")
    ...
    let atomicTypes = {atom: true, number: true, variable: true, string: true,
    ...
    function classfield(type, value) {
      ...
      let context = cx.state.lexical.prev, isInterface = context && context.info == "interface"
