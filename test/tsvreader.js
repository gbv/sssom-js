...
describe("TSVReader", () => {
  ...
  Object.entries({
    ...
    "uri.sssom.tsv": "license must be Uri at element /license: GPL",
    "array-value.sssom.tsv": "see_also must be Uri at element /see_also: //example.org/",
    "date.sssom.tsv": "mapping_date must be Date at element /mapping_date: 2020-13-01",
    "enum.sssom.tsv": "Invalid subject_type at element /subject_type: x",
